...
import { Attendance } from "../../daily-care/home-board.page"
...
export const StudentListTile: React.FC<Props> = ({ isRollMode, student, updateAttendace, isFilter, filterRollState }) => {
  return (
    <S.Container>
      ...
      {isRollMode && (
        <S.Roll>
          <RollStateSwitcher updateAttendace={updateAttendace} student={student} isFilter={isFilter} filterRollState={filterRollState} />
        </S.Roll>
      )}
    </S.Container>
  )
